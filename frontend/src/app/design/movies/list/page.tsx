    ...
    <div>
      ...
      {/* <Box className='header-wrap'>
        <Container maxWidth={false}>
          <Grid2 container spacing={2} className='large-container'>
            ...
            <Grid2 size={{ lg: 4, md: 4, sm: 4, xs: 4 }} className='header-rt'>
              <ul>
          ...
          <SwiperSlide>
            <Box className='movie-banner-inner'>
              <Box className='movie-banner-img-holder'>
                <Image fill src='/images/movie-banner.jpg' alt='' />
              </Box>
              <Box className='movie-banner-info'>
                <Container maxWidth='xl'>
                  <Box className='movie-banner-info-inner'>
                    <Box className='movie-tag'>Sci-Fi</Box>
                    <h2>Star wars: Episode III - The Revenge of the Sith</h2>
                    <p>
                      The evil Darth Sidious enacts his final plan for unlimited
                      power and the heroic Jedi Anakin Skywalker must choose
                      aside.
                    </p>
      ...
      <Box className='movie-list-wrap'>
        <Container maxWidth='xl'>
          <Box className='movielist-title'>
            <h3>Popular on Houses</h3>
            <ul>
              <li className='active'>Tarantino House</li>
              <li>Marvel Lovers House</li>
              <li>Podcast Bois House</li>
              <li>Alex Ryley</li>
            </ul>
          </Box>
      ...
      <Box className='movie-list-wrap movie-list-rating'>
        <Container maxWidth='xl'>
          ...
          <Box className='movie-list-inner'>
            ...
            >
              <SwiperSlide>
                <Box className='movie-each each-movie-rating'>
                  <Box className='movie-rating'>1</Box>
              ...
              <SwiperSlide>
                <Box className='movie-each each-movie-rating'>
                  <Box className='movie-rating'>2</Box>
              ...
              <SwiperSlide>
                <Box className='movie-each each-movie-rating'>
                  <Box className='movie-rating'>3</Box>
              ...
              <SwiperSlide>
                <Box className='movie-each each-movie-rating'>
                  <Box className='movie-rating'>4</Box>
              ...
              <SwiperSlide>
                <Box className='movie-each each-movie-rating'>
                  <Box className='movie-rating'>5</Box>
      ...
      <Box className='movie-list-wrap'>
        <Container maxWidth='xl'>
          <Box className='movielist-title'>
            <h3>
              Scary Fall Releases by <span>Letterboxd</span>
            </h3>
          </Box>
